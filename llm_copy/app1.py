...
def process_user_input(user_input, input_language):
    ...
    # Translate user input to English if the input language is not English
    if input_language != "en":
        translator = Translator()
        user_input_english = translator.translate(user_input, src=input_language, dest="en").text
    else:
        user_input_english = user_input

    retriever = vectorstore.as_retriever()
    docs = retriever.get_relevant_documents(user_input_english)
    ...
    # Translate the full response back to the original language if the input language was not English
    if input_language != "en":
        regional_translation = translator.translate(full_response, src="en", dest=input_language)
...
# Language selection
selected_language = st.selectbox("Select Language:", ["English", "Bengali", "Hindi"])

# Placeholder text based on selected language
if selected_language == "English":
    placeholder_text = "Type your question in English"
elif selected_language == "Bengali":
    placeholder_text = "আপনার প্রশ্ন টাইপ করুন"
else:
    placeholder_text = "अपना सवाल टाइप करें"
# Chat input box based on selected language

user_input = st.chat_input(placeholder_text)

# Map the selected language to language code
language_code = {"English": "en", "Bengali": "bn","Hindi": "hi"}.get(selected_language, "en")

if user_input and vectorstore is not None:
    process_user_input(user_input, language_code)
